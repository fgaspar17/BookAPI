...
public class AuthorQueryParametersValidator : AbstractValidator<GetAllQueryParameters>
{
    private HashSet<string> _sortColumns = new HashSet<string>(){ "firstname", "lastname", "birthday" };
